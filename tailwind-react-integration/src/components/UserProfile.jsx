function UserProfile() {
  return (
    <div className="bg-gray-100 sm:p-4 md:p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg bg-gray-100 p-8 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg">
